...
export function createBase2(
  ...
  return {
    ...
    spawnableAgents: buildArray(
      ...
      hasFreeGeminiThinker && SAVANT_FREE_GEMINI_THINKER_AGENT_ID,
      'thinker-gpt',
      'context-pruner',
    ),
...
function getBase2ContextPrunerMaxContextLength(
  ...
  if (model === SAVANT_FREE_MINIMAX_MODEL_ID) return 200_000
...
${buildArray(
  ...
  hasFreeGeminiThinker && SAVANT_FREE_GEMINI_THINKER_INSTRUCTIONS_PROMPT,
  (isDefault || isMax) &&
...
function buildImplementationStepPrompt({
  ...
  return buildArray(
    ...
    hasFreeGeminiThinker && SAVANT_FREE_GEMINI_THINKER_STEP_PROMPT,
    isMax &&
