...
- Join our [Discord community](https://savant-code.dev/discord) and ask your questions!
- Check our [documentation](https://savant-code.dev/docs) for more details

# What is Savant-Code?

Savant-Code is an **open-source AI coding assistant** that edits your codebase through natural language instructions. Instead of using one model for everything, it coordinates specialized agents that work together to understand your project and make precise changes.

Savant-Code beats Claude Code at 61% vs 53% on [our evals](https://github.com/savant-code/savant-code/tree/main/evals) across 175+ coding tasks over multiple open-source repos that simulate real-world tasks.

## How Savant-Code Works
...
This guide covers everything you need to know about building custom Savant-Code agents.
...
## Why Choose Savant-Code for Custom Agents
...
**Fully customizable SDK**: Build Savant-Code's capabilities directly into your applications with a complete TypeScript SDK. Create custom tools, integrate with your CI/CD pipeline, build AI-powered development environments, or embed intelligent coding assistance into your products.

Learn more about the SDK [here](https://www.npmjs.com/package/@savant-code/sdk).

## Community & Support

- **Discord**: [Join our community](https://savant-code.dev/discord) for help and inspiration
- **Examples**: Study the `examples/` directory for patterns
- **Documentation**: [savant-code.dev/docs](https://savant-code.dev/docs) and check `types/` for detailed type information
- **Issues**: [Report bugs and request features on GitHub](https://github.com/savant-code/savant-code/issues)
