...
This guide documents best practices for writing tests in the Savant-Code codebase, based on lessons learned from buffbench runs and production issues.
...
### âŒ DON'T: Use `afterAll` for mock restoration
...
### âœ… DO: Use `afterEach` for mock restoration
...
### âŒ DON'T: Use `as any` casts for mocks
...
### âœ… DO: Use typed mock factories
...
### âŒ DON'T: Assert on raw strings with formatting
...
### âœ… DO: Parse JSON and assert on structured fields
...
### âŒ DON'T: Use substring checks for role validation
...
### âœ… DO: Check exact field values
...
### âŒ DON'T: Share mutable state between tests
