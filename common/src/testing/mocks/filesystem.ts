...
import type { SavantFileSystem } from '../../types/filesystem'
...
export interface MockFs extends SavantFileSystem {}
...
/** Creates a mock filesystem compatible with SavantFileSystem. */
