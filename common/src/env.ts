...
if (env.NEXT_PUBLIC_SC_ENVIRONMENT !== 'prod') {
  console.log('Using environment:', env.NEXT_PUBLIC_SC_ENVIRONMENT)
}

// Derived environment constants for convenience
export const IS_DEV = env.NEXT_PUBLIC_SC_ENVIRONMENT === 'dev'
export const IS_TEST = env.NEXT_PUBLIC_SC_ENVIRONMENT === 'test'
export const IS_PROD = env.NEXT_PUBLIC_SC_ENVIRONMENT === 'prod'
