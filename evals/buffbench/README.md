...
BuffBench is Savant-Code's evaluation framework for measuring AI coding agent performance through real-world git commit reconstruction tasks.
...
Example comparing Savant-Code vs Claude Code:
...
```
evals/buffbench/
â”œâ”€â”€ run-buffbench.ts          # Main orchestrator
â”œâ”€â”€ main.ts                   # Example usage
â”œâ”€â”€ main-nightly.ts           # Nightly evaluation runner with email reporting
â”œâ”€â”€ main-single-eval.ts       # Single evaluation runner
â”‚
â”œâ”€â”€ agent-runner.ts           # Executes agents in test repos
â”œâ”€â”€ judge.ts                  # AI judging system
â”œâ”€â”€ trace-analyzer.ts         # Per-task trace analysis
â”œâ”€â”€ meta-analyzer.ts          # Cross-task meta analysis
â”‚
â”œâ”€â”€ gen-evals.ts              # Generate eval tasks from commits
â”œâ”€â”€ gen-repo-eval.ts          # End-to-end eval creation
â”œâ”€â”€ eval-task-generator.ts    # Task prompt generation
â”‚
â”œâ”€â”€ format-output.ts          # Result formatting utilities
â”œâ”€â”€ trace-utils.ts            # Trace processing utilities
â”œâ”€â”€ lessons-extractor.ts      # Extract lessons from failures
â”‚
â”œâ”€â”€ types.ts                  # Type definitions
â”‚
â”œâ”€â”€ eval-savant-code.json        # Savant-Code project evaluations
â”œâ”€â”€ eval-manifold.json        # Manifold evaluations
â”œâ”€â”€ eval-plane.json           # Plane project evaluations
â””â”€â”€ eval-saleor.json          # Saleor e-commerce evaluations
```
...
interface AgentEvalResults {
  ...
  averageScoreExcludingFailures: number // Score excluding failures (â‰¤1.0)
  averageCost: number
...
â”œâ”€â”€ 1-task-id-agent1-abc123.json      # Agent 1 trace for task 1
â”œâ”€â”€ 1-task-id-agent2-abc123.json      # Agent 2 trace for task 1
â”œâ”€â”€ 1-task-id-ANALYSIS-abc123.json    # Trace analysis for task 1
â”œâ”€â”€ 2-task-id-agent1-def456.json      # Agent 1 trace for task 2
â”œâ”€â”€ 2-task-id-agent2-def456.json      # Agent 2 trace for task 2
â”œâ”€â”€ 2-task-id-ANALYSIS-def456.json    # Trace analysis for task 2
â””â”€â”€ FINAL_RESULTS.json                # Complete results + meta-analysis
```
...
# Optional
EVAL_RESULTS_EMAIL=team@savant-code.dev  # For nightly email reports
```
...
- **eval-savant-code.json** - Savant-Code project evaluations
