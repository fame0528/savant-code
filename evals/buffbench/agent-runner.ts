...
import { Savant-CodeRunner } from './runners/savant-code'
...
import type { SavantClient } from '@savant-code/sdk'
...
async function runFinalCheckCommands(
  ...
  for (const command of commands) {
    ...
    try {
      ...
      console.log(`  âœ— Command failed (exit ${error.code}): ${command}`)
    }
  }
