...
export const Chat = ({
  ...
  // empty-input default-mode chat â€” and never while a menu/overlay is up.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {ads?.[0] && (IS_SAVANT_FREE || getAdsEnabled()) && (
          <SingleAdBanner
            ad={ads[0]}
            onClick={recordClick}
        ...
        {reviewMode ? (
          ...
          // reachable for the run to finish â€” otherwise the agent hangs
              ...
              onPaste={createPasteHandler({
                ...
                onPasteLongText: (pastedText) => {
                  ...
                  showClipboardMessage(
                    `ðŸ“‹ Pasted text (${pastedText.length.toLocaleString()} chars)`,
                    { durationMs: 5000 },
                  )
                },
