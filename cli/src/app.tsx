...
const AuthedSurface = ({
  ...
  //   null     â†’ initial GET in flight (brief)
  //   'none'   â†’ no seat yet; show model-picker landing
  //   'queued' â†’ waiting our turn
  //   'country_blocked' â†’ terminal region-gate message
  //   'banned' â†’ terminal account-banned message
  //   'rate_limited' â†’ hit shared session quota; terminal for this run
  //   'takeover_prompt' â†’ another local CLI already holds this account
  //
