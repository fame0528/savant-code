      ...
      <box style={{ flexDirection: 'column', gap: 1, flexGrow: 1 }}>
        ...
        <box style={{ flexDirection: 'column', gap: 0 }}>
          ...
          <box style={{ flexDirection: 'row', flexWrap: 'wrap', columnGap: 2, paddingLeft: 2 }}>
            ...
            <Shortcut keys="â†‘â†“" action="history" />
        ...
        <box style={{ flexDirection: 'column', gap: 0 }}>
          ...
          <box style={{ flexDirection: 'column', paddingLeft: 2 }}>
            {IS_SAVANT_FREE && !chatGptOAuth.connected && (
            ...
            {IS_SAVANT_FREE && chatGptOAuth.connected && (
              <text style={{ fg: theme.muted }}>
                Try workflow: /interview â†’ /plan â†’ implement â†’ /review
              </text>
            )}
            <text style={{ fg: theme.muted }}>
            ...
            <text style={{ fg: theme.muted }}>
              Drag to select text â€” it copies automatically (or click âŽ˜ on a
              message)
            </text>
            <text style={{ fg: theme.muted }}>
        ...
        {!IS_SAVANT_FREE && (
          <box style={{ flexDirection: 'column', gap: 0 }}>
            ...
            <box style={{ flexDirection: 'column', paddingLeft: 2 }}>
              ...
              <text style={{ fg: theme.muted }}>
                Subscribe for the best credit rates â€” /subscribe
              </text>
            </box>
          </box>
        )}
