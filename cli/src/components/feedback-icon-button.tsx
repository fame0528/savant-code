...
export const FeedbackIconButton: React.FC<FeedbackIconButtonProps> = ({
  ...
  const symbolsByCategory: Record<string, string> = {
    good_result: 'â–²â–½', // Good selected - filled up, outlined down
    bad_result: 'â–³â–¼', // Bad selected - outlined up, filled down
  }
  const textCollapsed = symbolsByCategory[selectedCategory || ''] || 'â–³â–½'
