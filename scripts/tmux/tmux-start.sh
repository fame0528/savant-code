...
#                       non-Savant-Code apps, or use --binary)
...
#   -b, --binary [PATH] Use compiled binary (Savant-Code-specific shortcut)
...
#
#   # Start with default Savant-Code dev server (backward compatible)
...
#
#   # Test a compiled binary (Savant-Code default location)
...
if [[ -n "$CUSTOM_COMMAND" ]]; then
    ...
    # Default mode - Savant-Code dev server via bun (for backward compatibility)
