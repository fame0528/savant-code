...
;(async () => {
  ...
  console.log('âœ… getBundledRgPath types work correctly')
  ...
  console.log('âœ… codeSearch parameter types work correctly')
  ...
  try {
    ...
    console.log('âœ… getBundledRgPath runtime execution matches types')
    ...
    console.log('âœ… codeSearch runtime execution matches types')
  } catch (error) {
  ...
  console.log('âœ… Optional parameters compile correctly')

  // Test 5: Test type constraints
  console.log('\n5. Testing type constraints...')

  // These parameters are validated at compile time
  console.log('âœ… Type constraints work as expected')

  console.log('\nðŸŽ‰ All ripgrep TypeScript type tests passed!')
})().catch((error) => {
  console.error('\nâŒ TypeScript type test failed:', error.message)
  process.exit(1)
})
