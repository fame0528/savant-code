...
console.log('ðŸ§ª Testing ripgrep bundling functionality...')
...
try {
  ...
  console.log('âœ… Ripgrep functions imported successfully')
  ...
  console.log('âœ… Ripgrep path found:', rgPath)
  ...
  console.log('âœ… Ripgrep binary exists on filesystem')
  ...
  console.log('âœ… Using bundled ripgrep binary (not @vscode/ripgrep)')
  ...
  console.log('âœ… Basic code search successful')
  ...
  console.log('âœ… Search found all expected files')
  ...
  console.log('âœ… Search with flags works correctly')
  ...
  if (!hasOnlyJs && typeFilteredLines.length > 0) {
    console.warn('âš ï¸ File type filtering may not be working as expected')
  } else {
    console.log('âœ… File type filtering works correctly')
  }
  ...
  console.log('âœ… Error handling works (no crashes)')
  ...
  try {
    ...
    console.log('âœ… Environment variable override works')
  } finally {
  ...
  console.log('\nðŸŽ‰ All ripgrep bundling tests passed!')
} catch (error) {
  console.error('\nâŒ Ripgrep bundling test failed:', error.message)
