...
This folder contains end-to-end tests, integration tests, unit tests, and runnable examples for the Savant-Code SDK.

## Directory Structure

```
sdk/e2e/
â”œâ”€â”€ streaming/          # E2E tests for streaming behavior
â”œâ”€â”€ workflows/          # E2E tests for multi-step workflows  
â”œâ”€â”€ custom-agents/      # E2E tests for custom agent & tool integration
â”œâ”€â”€ features/           # E2E tests for SDK feature coverage
â”œâ”€â”€ integration/        # Integration tests (SDK + API mechanics)
â”œâ”€â”€ examples/           # Runnable example scripts (not tests)
â””â”€â”€ utils/              # Shared utilities
    â”œâ”€â”€ __tests__/      # Unit tests for utilities
    â”œâ”€â”€ event-collector.ts
    â”œâ”€â”€ get-api-key.ts
...
| `event-ordering` | Validates event sequence (start â†’ content â†’ finish) |
...
describe('E2E: My Test', () => {
  let client: SavantClient

  beforeAll(() => {
    if (skipIfNoApiKey()) return
    client = new SavantClient({ apiKey: getApiKey() })
  })
